...
sc.hideturtle()
sc.goto(0,260)
sc.write("Score: 0 High score: 0", align = "center", font=("ariel", 28, "normal"))
...
while True:
    ...
    if head.xcor() > 290 or head.xcor()<-290 or head.ycor()>290 or head.ycor()<-290:
        ...
        sc.clear()
        sc.write("Score: {} High score: {}".format(score, high_score), align="center",font=("ariel", 28, "normal"))
    
        

    #Check for a collision with the food
    if head.distance(food) < 20:
        # Move the food to a random spot when snake ate the food
